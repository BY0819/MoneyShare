...
//        dataSetting();
        ...
        Retrofit divideretrofit = new Retrofit.Builder()
         ...
         Call<DivideData> request = divideApi.getDivideData(1);

         request.enqueue(new Callback<DivideData>() {
             @Override
             public void onResponse(Call<DivideData> call, Response<DivideData> response){
                 ...
                 if(response.isSuccessful()){
                    ...
                    Toast.makeText(DivideActivity.this,"네트워크 성공",Toast.LENGTH_SHORT).show();
